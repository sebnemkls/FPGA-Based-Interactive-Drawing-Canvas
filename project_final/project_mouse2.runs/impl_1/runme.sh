...
HD_PWD='C:/Users/sebne/project_mouse2/project_mouse2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log draw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source draw.tcl -notrace
